...
type addCounterPartySigsMsg struct {
	...
	// This channel is used for the wallet to pass the completed channel
	// back into the Funding Manager at the final stage in the funding
	// process. Because the Funding Manager will be create the final
	// channel (using lnwallet.NewLightningChannel) once the funding
	// transaction has been confirmed, it requires the full channel state.
